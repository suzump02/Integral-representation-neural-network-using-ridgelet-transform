...
\begin{align}
  \psihat(\z) = \z^{2k-1} e^{-\z^2/2}, \quad k \in \mathbb{N}.
\end{align}
...
\begin{align*}
  ...
  &= \int_{-\infty}^{\infty} \z^{2k-1} e^{-\z^2/2} e^{i \z x} \, \dd\z.
\end{align*}

Here, let $I = \int_{-\infty}^{\infty} e^{-\z^2/2} e^{i \z x} \, \dd\z$.
From easily calculation, we have
  \begin{align*}
    I &= \int_{-\infty}^{\infty} e^{-\z^2/2} e^{i \z x} \, \dd\z \\
    &= e^{-\frac{x^2}{4}} \int_{-\infty}^{\infty} e^{-\frac{1}{2}(\z - ix)^2} \, \dd\z \\
    &= e^{-\frac{x^2}{4}} \sqrt{2\pi}.
  \end{align*}

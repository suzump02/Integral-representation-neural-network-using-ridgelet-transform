...
Fourier transforms are defined as follows:
\begin{align*}
  \F[f](\vw) = \hat{f}(\vw) &\coloneqq \intinf f(\vx) \, e^{i \vw \cdot \vx} \, \dx
\end{align*}

\begin{align*}
  \F^{-1}[\hat{g}](\vx) &\coloneqq \frac{1}{(2\pi)^m} \intinf \hat{g}(\vw) \, e^{-i \vw \cdot \vx} \, \dw
\end{align*}
...
\begin{align}
  ...
  &= \intrm \dx \, f(\vx) \, \intrm \dw \intinf \dd z \, \left( \frac{1}{2\pi}\intinf \dd \z \, \psihat(\z) e^{i\z z}\right) \, \eta(\vw \cdot (\vy - \vx) + z) \label{c}\\
  &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intrm \dw \intinf \dd z \, \intinf \dd \z \, \psihat(\z) e^{i\z z} \, \eta(\vw \cdot (\vy - \vx) + z)\label{d}\\
  &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intrm \dw \intinf \dd \z \, \psihat(\z) \intinf \dd z \,e^{i\z z} \, \eta(\vw \cdot (\vy - \vx) + z)\label{e}
\end{align}
...
\begin{align}
  \text{(RHS)} &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intrm \dw \intinf \dd \z \, \psihat(\z) \intinf \dd z' \, e^{i\z z'} \, e^{- i\z \vw \cdot (\vy - \vx)}\, \eta(z')\\
  &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intrm \dw \intinf \dd \z \, \psihat(\z) \, e^{- i\z \vw \cdot (\vy - \vx)} \intinf \dd z' \, \eta(z') \, e^{i\z z'} \\
  &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intrm \dw \intinf \dd \z \, \psihat(\z) \, e^{- i\z \vw \cdot (\vy - \vx)} \, \etahat(\z)\\
  &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intinf \dd \z \, \psihat(\z) \, \etahat(\z) \intrm \dw \, e^{- i\z \vw \cdot (\vy - \vx)}\\
\end{align}

Considering the transformation from $\z\vw$ to $\vw'$, and noting that its Jacobian is $\absz^m$:

\begin{align}
  \text{(RHS)} &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intinf \dd \z \, \psihat(\z) \, \etahat(\z) \intrm \frac{\dw}{\absz^m} \, e^{- i\vw' \cdot (\vy - \vx)}\\
  &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intinf \dd \z \, \dfrac{\psihat(\z) \, \etahat(\z)}{\absz^m} \intrm \dw \, e^{- i\vw' \cdot (\vy - \vx)}\\
  &= \frac{1}{2\pi}\intrm \dx \, f(\vx) \, \intinf \dd \z \, \dfrac{\psihat(\z) \, \etahat(\z)}{\absz^m} \, (2\pi)^m \, \left(\frac{1}{(2\pi)^m}\intrm \dw \, e^{- i\vw' \cdot (\vy - \vx)}\right)\\
  &= (2\pi)^{m-1}\intrm \dx \, f(\vx) \, \intinf \dd \z \, \dfrac{\psihat(\z) \, \etahat(\z)}{\absz^m} \, \delta(\vy - \vx)\\
  &= (2\pi)^{m-1}\intinf \dd \z \, \dfrac{\psihat(\z) \, \etahat(\z)}{\absz^m} \, \intrm \dx \, f(\vx)  \, \delta(\vy - \vx)\\
  &= (2\pi)^{m-1}f(\vy) \, \intinf \dd \z \, \dfrac{\psihat(\z) \, \etahat(\z)}{\absz^m}. 
\end{align}
